...
public class Login extends BorderPane {
    ...
    public Login(Stage stage) throws IOException {
        ...
        ImageView imagen = new ImageView("LogoV22.PNG");
        ...
        iuser.setFitWidth(200.0);
        iuser.setFitHeight(200.0);
        ...
        this.gridForm.setVgap(2.0);
        this.gridForm.setHgap(2.0);
        ...
        test.setTranslateX(100.0);
        test.setTranslateY(10.0);

        this.btnIniciar.setTranslateX(125.0);
