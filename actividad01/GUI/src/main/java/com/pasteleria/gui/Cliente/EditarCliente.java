...
public class EditarCliente extends GridPane {
    ...
    public EditarCliente(Stage stage, ClienteEntidad cliente, DireccionEntidad direccion, int seleccion, TablaCliente tablaCliente, Label lDatosCliente) {
        this.cliente = cliente;
        this.tablaCliente = tablaCliente;
        this.direccion = direccion;
        this.lDatosCliente = lDatosCliente;
        ...
        /*btnAceptar.setOnAction(evtm->{
            lDatosCliente.setText(cliente.toString());
    ...
    public void inicializarComponentes(){
        ...
        lTitulo = new Label("Datos cliente");
        lDatosCliente = new Label(" ");*/
