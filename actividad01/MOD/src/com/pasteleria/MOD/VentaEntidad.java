...
@NamedQueries({
        ...
        @NamedQuery(name = "Ventas.ListarClientes", query = "select ventas from VentaEntidad ventas where ventas.clienteByClienteIdCliente = :id"),
})
...
//    }
    ...
    public void setClienteByClienteIdCliente(ClienteEntidad clienteEntidad) {
        this.clienteByClienteIdCliente = clienteByClienteIdCliente;
    }
